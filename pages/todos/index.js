        ...
        <MainComponent>
            <div className={classes.wrapper}>
                <form className={classes.input_form}>
                    ...
                    <button className={ classes.btn + ' ' +classes.btn_add}><i className="gg-add"></i></button>
                </form>
                <div className={classes.todo_item + ' ' + classes.item_todo }>
                    <p className={classes.todo_text}>Сделать какое-то действие блабла </p>
                    <button className={classes.btn + ' ' +  classes.btn_close}>
                        <i className="gg-check-o"></i>
                    </button>
                    <button className={classes.btn + ' ' + classes.btn_delete}>
